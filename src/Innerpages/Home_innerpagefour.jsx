          ...
          <div className='grid sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-4'>
              ...
              <div className='flex'>
                ...
                <IoCheckmarkOutline size={25}/>
                  ...
                  <p className='text-lg pt-2 pb-4'> In today's digital economy, brands and businesses must deliver visually 
                  rich media experiences across all digital channels to meet the expectations of modern consumers</p>
                  </div>    
