        ...
        <div className='grid md:grid-cols-3 '>
            ...
            <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
               ...
               <div>
                ...
                <div className='text-xl'>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span> Upload widget, API, and search </p>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span>  Remote fetch, auto-backup, and revision tracking</p>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span> Image and video transformations  </p>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span> Video transcoding and adaptive streaming </p>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span> High performance delivery through a CDN</p>
            ...
            <div className='bg-white text-slate-900 m-4 p-8 rounded-xl shadow-2xl relative'>
               ...
               <div>
                ...
                <div className='text-xl'>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span> Custom domain (CNAME) support </p>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span>Optional HTTPS SSL Certificate</p>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span> Authentication Options </p>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span> Remote fetch, auto-backup, and revision tracking </p>
                   <p className='flex py-4'> <span className='w-5 mr-5 text-green-600'> {IoCheckmarkOutline} </span> High performance delivery through a CDN </p>
                   <button className='w-full py-4 my-4 bg-slate-900 text-white rounded-2xl'>Get started</button>
                </div>
