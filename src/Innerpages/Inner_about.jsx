...
const Inner_about=()=> {
  ...
  <div className='pt-[8vh] '>
      ...
      <div className='text-center py-8'>
                ...
                <p className='text-3xl py-6 text-gray-600'>Transform images and videos to load faster with no visual 
                degradation,some processing takes place on an end user's local hardware,such as a desktop or mobile devices
                and some takes place on a remote saver.</p>
    ...
    <div>
    <img src={christina} alt="bg-image" />
